...
class FoodEmp extends StatefulWidget { // Changed class name here
  const FoodEmp({super.key}); // Changed constructor name here

  @override
  State<FoodEmp> createState() => _FoodEmpState(); // Changed state class name here
}

class _FoodEmpState extends State<FoodEmp> with SingleTickerProviderStateMixin { // Changed state class name here
